...
class VM:
    ...
    def __init__(self, username, password, disk_image=None, num=0, ram=8192):
        ...
        self.qemu_args.extend(
            [
                ...
                "-drive",
                "file=%s,if=none,id=drive-sata-disk0,index=0,media=disk,format=qcow2"
                % overlay_disk_image,
            ]
        )
...
class VR:
    ...
    def start(self):
        ...
        #TODO: 443 already in use. Must fix this to play with restconf
        #run_command(
